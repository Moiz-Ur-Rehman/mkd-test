...
function checkAllergie() {
  // terminate quiz if user clicks banana, olives or sunflowers
  if (
    tempSelectionAns.includes("Banana") ||
    tempSelectionAns.includes("Olive") ||
    tempSelectionAns.includes("Sunflowers")
  ) {
    terminateQuiz();
  }
}
